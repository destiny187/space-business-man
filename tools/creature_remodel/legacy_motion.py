"""Legacy axial waves, propulsive membranes, grasping organs and host-timed attacks."""
import math
import bpy
    ...
    for state,duration in states:
        ...
        for f in range(count+1):
            ...
            for leg in s.legs:
                ...
                if state=='attack' and kind=='runner' and leg['name']=='hind1':foot+=V((0,-.58*strike,.46*strike))
                if state=='leap_air':
