...
JOBS=[('amb_surface_foliage_v1', 'Soft_leaves_and_shor_#1', 'Dc2FFSLHRMFJVGtfd4Rr', True, 'Soft leaves and short grasses rustling in a gentle breeze, close textured foliage movement with tiny natural pauses, even four-second loop for a quiet restored alien meadow. No animals, birds, insects, voices, music, machinery or dramatic gusts.'), ('sfx_surface_ice_v1', 'A_small_natural_ice__#1', '8rvG820h95N35PrghZqf', False, 'A small natural ice sheet settling with two delicate crystalline cracks and a low rounded ice resonance, outdoors on a quiet frozen plain. Four seconds, isolated natural ice foley, no metal, machinery, explosion, voices, wind or music.'), ('amb_surface_shallows_v1', 'Gentle_shallow_water_#1', 'ftY2T9YR3OXDCB9QKjlJ', True, 'Gentle shallow water lapping softly over small stones at the edge of a tiny pond, delicate close ripples and occasional small droplets. Even continuous four-second natural loop, no pump, machinery, stream roar, animals, birds, voices or music.')]
jobs=[]
for id,prefix,history,loop,prompt in JOBS:
 ...
 print(id,'IMPORTED')
(ROOT/'audio/manifests/surface-recovery.json').write_text(json.dumps({'date':'2026-09-09','jobs':jobs},ensure_ascii=False,indent=2)+'\n')
