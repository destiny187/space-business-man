"""CooperTech combat chassis. Preserve the original metre envelope and animation pivots."""
def build_robot(p, api):
    ...
    armor=mat('CooperTech graphite armour',(.075,.095,.105),.38,.43)
    edge=mat('CooperTech worn armour',(.22,.255,.26),.5,.4)
    marking=mat('CooperTech oxide markings',(.27,.037,.018),.18,.57)
