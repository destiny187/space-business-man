...
func run() -> void:
 ...
 var folder:=ProjectSettings.globalize_path("res://../docs/production/media/planet-variety")
 ...
 var names: Array[String]=["basalt_columns","porous_tuff","sandstone_bedded","frost_fracture","salt_polygons","impact_breccia","folded_slate"]
 for i in names.size():
