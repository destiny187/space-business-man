...
func run() -> void:
	...
	site.robots["robot:900"]={"id":"robot:900","grade":"standard","position":FrontierExpeditionBusiness.array(robot_point),"battery":100.0,"cargo":FrontierExpeditionBusiness.inventory(),"phase":"outbound","target":vein.id,"path":[],"status":"광맥으로 이동","work":0.0,"charging":false}
	...
	print("ROBOT_WORK_FAILURES ",failures);quit(1 if failures else 0)
