...
func _ready() -> void:
 samples=[]
 var names: Dictionary={"dew_condenser":"응결 집수기","geothermal_generator":"열수 발전기"}
...
func capture_industry() -> void:
 helper.hide()
 var dest:="res://../output/discovery-industry/"
 ...
 print("DISCOVERY_INDUSTRY_RENDER ",suffix);get_tree().quit()
