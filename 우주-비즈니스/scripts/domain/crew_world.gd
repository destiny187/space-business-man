...
static func validate(value: Variant) -> String:
	...
	if value.has("space_combat") and not FrontierSpaceCombat.valid(value.space_combat):return "우주 교전 기록 오류"
