...
static func content_hash() -> String:
	return (FileAccess.get_file_as_string("res://data/crew_locomotion.json")+FileAccess.get_file_as_string("res://data/crew.json")+FileAccess.get_file_as_string("res://data/galaxy.json")+FileAccess.get_file_as_string("res://data/space_presentation.json")+FileAccess.get_file_as_string("res://data/terrain.json")+FileAccess.get_file_as_string("res://data/crew_surface.json")+FileAccess.get_file_as_string("res://data/ecology.json")+FrontierEcologyCatalog.signature()+FrontierExpeditionBusiness.signature()+FrontierFieldEngineering.signature()+FrontierVesselRefit.signature()+FileAccess.get_file_as_string("res://data/equipment.json")+FileAccess.get_file_as_string("res://data/production_tier2.json")+FileAccess.get_file_as_string("res://data/mineral_world.json")+FileAccess.get_file_as_string("res://data/minerals.json")+FileAccess.get_file_as_string("res://data/planet_diversity.json")+FileAccess.get_file_as_string("res://data/system_diversity.json")+FileAccess.get_file_as_string("res://data/surface_details.json")+FileAccess.get_file_as_string("res://data/flight_experience.json")+FileAccess.get_file_as_string("res://data/celestial_names.json")).sha256_text()
