...
func _title_menu(column: VBoxContainer) -> void:
	...
	_button(column,"우주 탐험  →",func(): get_tree().change_scene_to_file("res://scenes/app/exploration.tscn"))
	_button(column,"함께하는 원정 · 최대 6명",func(): get_tree().change_scene_to_file("res://scenes/app/crew_expedition.tscn"))
