...
2026-09-14 **실플레이 수정 요구·구현 대기**: 유실 화물의 정지 중 F 연결과 견인선 운반 단순화는 2번을 따른다. 일반 화물·mine 정비·수송선 구조 SOS의 완료 문제는 4번 조사로 구분한다. [18항목 요구·답변·코드 열람·분할 계획](../planning/19-playtest-feedback-september14.md)에 이번 변경의 단일 명세와 확인 경계를 둔다.
