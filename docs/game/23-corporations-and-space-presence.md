...
![네 회사 심볼 제작안 v2](media/corporations/company-symbols-v2.svg)

그림은 쿠퍼테크의 장갑 C·구조재 T로 교체한 **벡터 제작안 v2**다. 현재 원본·출력·변경 범위는 [쿠퍼테크 전환 기록](../production/106-coopertech-rebrand.md)을 따른다. v0/v1은 폐기된 회사가 포함된 과거 비교 자료이며 현재 제작 기준이 아니다. 최종 로고 승인·Blender 제작·게임 적용·INK 렌더 검수를 뜻하지 않는다. 색상은 제조사 식별 제안이며 게임의 선택·적대 상태 색상을 대체하지 않는다.
...
| **쿠퍼테크(CooperTech)** | 쿠퍼가 이끄는 강력한 전투로봇 기술회사 | **장갑 프레임 C와 두꺼운 구조재 T**. 흑연 외장·강철 표식·산화 적색 식별판 | 경사 장갑, 보호된 광학부, 견고한 동력부와 무장 고정부. 포탑/센서의 준비→조준→사격→냉각을 기계 동작으로 표현 |
...
| 제한 연구권 | 쿠퍼테크 시험/보안 거점 + 제한된 물류 연결 | 봉인 수송선·감시 드론 | 경계 비콘·CT 장갑 표식·폐기 로봇 |
...
| CooperTech 감시 경계 | CT 경계 비콘·센서 추적·접근 경고 | 관측·우회·제한선 안쪽 조사 선택 | 조사 정보 또는 사건 상태 변화 | 감시 범위·경고 전조. 적대 대응은 회사 관계 결정 후 |
