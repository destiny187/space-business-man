...
2026-09-14 [전체 동물의 체형별 빠른 이동](production/177-creature-fast-motion-rollout.md): 5,600종에 빠른 동작 5,671개를 추가하고 보폭에 맞는 최고속·가속/감속·선회·위치 보간을 연결했다. 골격 11,200개 전수 대조, 대표 17종 Blender/Forward+와 실제 T4 교전·저장을 확인했다. 전종 개별 미적 검수·외부망/6인·수중/비행 전투 AI와 배포 검증은 소관 기록에서 구분한다.
