...
2026-09-15 [지하 안전, 장비 손, 탄약과 지표 로딩](production/199-ground-safety-hands-and-loading.md): 200m 기반암과 추락 방지, Blender 양손, 탄약/R 안내, 행성 준비 완료 후 로딩 해제 및 착륙 선체 보행 충돌을 반영한다.

2026-09-15 [권총 제작 멈춤과 채굴 지연 조사](production/198-crafting-and-mining-stall.md): Windows 드라이버 응답 중지와 무기 상세 오류를 구분하고, 숨긴 탭 상세 갱신 및 광맥 잔량 변경의 처리 범위를 수정한다. 전체 멈춤/프레임 드랍 해소와 구분한다.

2026-09-15 [초반 플레이 수정 9항목](production/197-early-play-fixes.md): 항해 입력/시점, 스캔 강조, 새 첫 행성, 메뉴 위치, 선택 화물 회수와 굴착 갱신 범위를 수정했다. 기존 원정의 생성 결과를 보존한다.

2026-09-15 [발견 실용 설비 네 종류](production/196-discovery-utilities.md): 껍질 보호, 표본 배양 조명, 실제 침수 경보와 공명음을 별도 연구 및 건설로 연결한다. 기존 정적 전시품은 유지한다.

2026-09-14 [특수 발견 전시품](production/195-discovery-exhibits.md): 발견 21종과 사건 22종 모두 연구 후 제작하고 지표에 배치하는 전시품을 추가했다. 기존 집수 및 발전 효과와 장식의 차이를 J 도감에 설명한다.

2026-09-14 [발견 산업 첫 연결](production/194-discovery-industry.md): 이슬 돌그릇 연구의 응결 집수기와 열수 굴뚝 연구의 열수 발전기를 실제 환경 및 현장 공급에 연결했다. 각 설비는 한 번 강화하고 원본 자연물과 결합한 Blender 모델을 사용한다. 자성 선별, 생물 반응조 등 후속 연결은 [발견 활용](game/30-special-discovery-uses.md)에 별도 설계했다.

2026-09-14 [특수 발견 활용](game/30-special-discovery-uses.md), [계열별 설비와 강화](game/31-facility-growth-and-tradeoffs.md), [복수 제조법](game/32-alternative-manufacturing-recipes.md)을 상세 설계했다. 발견 21종, 사건 22종과 미구현 후보 30종을 구분한다. 시설은 계열별 서로 다른 3종과 개별 1회 강화로 정정하고 같은 제품의 고티어 원료 경로를 추가했다. [개발 순서](planning/20-special-discovery-and-facility-growth.md)를 포함한 문서 작업이며 신규 기능은 개발 대기다.

2026-09-14 [현장 제작과 항해, 스캔 후속](production/193-field-and-navigation-followup.md): 금속 가공 공장과 장비 제작대, F 접근 속도, 성간 가감속과 추정 속도, 마지막 보급 가이드, 스캔 결과 유지와 중간점 제거를 반영했다. 특수 도감과 고티어 시설은 별도 고도화 설계이며 저장 실패 제보 조사는 사용자 지시로 제외한다.

2026-09-14 [유실 화물 F 연결·홈 버전](production/192-freight-hold-and-home-version.md): 연결 게이지 중 포드 이동을 제거하고 완료 후 F를 놓아도 견인한다. 홈 우측 하단 소스 버전과 3D 배경의 오른쪽 배치를 연결했다.

2026-09-14 추가 확정: 누구든 자기 배낭 재료로 건설하며, 한 명이 달성한 튜토리얼 단계는 원정 전체가 공유한다. 늦은 입장·저장 재개도 공용 진행을 받는다. 가이드 숨김/편지 읽음은 개인 설정이며 [공용 튜토리얼](production/191-shared-play-guide.md)의 17개 규칙·16개 실제 원정 확인 범위를 따른다.

2026-09-14 사용자 정정: 건물 모델은 유지하고 클릭 설치 순간의 홀로그램 조립·접합·완료 연출을 고도화했다. 누구나 건설하며 실제 내부 판정 뒤 연출한다. [190 구현·검수](production/190-construction-animation.md).

2026-09-14 [현장 건물 9종 형태 고도화](production/189-field-facility-design.md): 역할별 구조·공통 기초판·Blender/GLB·투명 건설 카드를 교체했다. Forward+ 개별/혼합 렌더와 실제 배치·비용·가동·저장 23항목을 확인했다.

2026-09-14 **실플레이 20항목 분할 인계**: 요청한 수정 묶음을 10개 개발 커밋으로 반영했다. FINCH 이륙·공통 T·우주 안내/견인·지도/날씨·지표 드롭·발견 기록·연구/가이드를 연결했다. SOS와 시야 회전 지연은 조사 결과·미재현 범위를 남긴다. [188 번호별 상태/실제 검수](production/188-playtest-feedback-delivery.md#번호별-최종-인계)가 아래 과거 개발 대기/진행 중 기록보다 최신이다.

2026-09-14 **17번 연구/건설 진입 수정**: 착륙선 연구의 잘못된 J 연결을 실제 공동 설비 탭으로 수정하고 미해금 건물을 숨겼다. 재료 부족 카드는 유지하며 실제 960px 연구 구매·건설 카드·저장 16항목을 확인했다. [분할 기록](production/188-playtest-feedback-delivery.md).

2026-09-14 **실플레이 19번 FINCH 이륙 수정** — [188 분할 구현](production/188-playtest-feedback-delivery.md): 1인 탑승 후 카메라 미준비 오류를 재현하고 선체 준비·지형 유지·우주 인계를 수정했다. 실제 Forward+ 14항목·화물/저장 확인, 나머지 항목은 진행 중이다.

2026-09-14 **실플레이 추가 2항목** — [총 20항목 계획](planning/19-playtest-feedback-september14.md): FINCH 단독 이륙 후 지하 진입·시야 고정·멈춤을 최우선으로 추가하고, 빈 우주 공간 5초 응시 후 항로 후보를 표시하는 안을 정리했다. 코드 의심 경로와 실제 재현/수정 대기를 구분한다.

2026-09-14 **실플레이 18항목 정리·개발 대기** — [분할 계획](planning/19-playtest-feedback-september14.md): 안내/공통 T 스캔·견인·접근 가속·지도 캐시·날씨·바닥 회수·연구/튜토리얼을 정리했다. 실제 지형 유지, 미해금 건물만 숨김, 단순 발견 보상 제거·도감 유지가 후속 확정이다. SOS·속도·시야는 코드 열람과 실제 조사 대기를 구분한다. 게임 코드·실행 검사는 변경/수행하지 않았다.
...
2026-09-14 **고도화 3/3 구현** — [Q07~Q09](production/183-polish-combat-audio-and-coop.md): 전투 표시 시계·피해 숫자·효과/환경 믹스·승무원 상태/참가 순서·재합류 위치를 보강했다. 실제 Forward+ 33항목·기존 이동/접촉 22항목을 확인했다. Q01~Q09 초기 구현은 끝났으며 장시간 체감·전수/외부망 검수는 소관 기록에 남겼다.

2026-09-14 **고도화 2/3 구현** — [Q04~Q06](production/182-polish-production-and-restoration.md): 알려진 사용처·제작소/창고 위치·묶음 최대량·로봇 상태/조치·환경 설비/정산 비교를 연결했다. 실제 생산/출고와 표시용 알림 확인의 경계는 기록을 따른다.

2026-09-14 **고도화 1/3 구현** — [Q01~Q03 제작 기록](production/181-polish-settings-input-and-industry.md): 설정 범위/저장 병합·현재 원정 키 설정/배율·운영 현장 산업 초안을 연결했다. 실제 Forward+와 국소 저장 검사를 완료했다. 아래 문서화 대기 상태보다 이 기록이 우선하며 Q04~Q09는 이어서 진행한다.

2026-09-14 **고도화 계획 문서화** — [기존 플레이 Q01~Q09](planning/17-existing-play-polish-plan.md): 설정·입력·저장 반응성·첫 목표·자동화·복원/정산·전투·음향·협동의 개선 방식과 단계별 완료 기준을 구체화했다. 개발자가 추가 제보 없이 먼저 진행할 수 있는 계획이며 게임 구현은 대기 상태다.

2026-09-14 **조사·보강 제안** — [기존 플레이 완성도 조사](production/180-existing-game-polish-audit.md): 입력 신뢰·저장/설정 처리 범위·첫 채집 이후 목표·자동화 효용·복원/정산의 성취를 우선순위로 정리했다. 코드 확인·기존 검수 한계·사용자 플레이 가설을 구분하며 게임 실행/수정은 하지 않았다.

2026-09-14 [우주전 피격음·피해 숫자](production/179-space-damage-feedback.md): 기존 타격/실드 파괴음을 확인하고 일반 실드 타격음을 구분했다. 지상과 같은 대상별 실제 피해 합산·실드 파괴 표식을 연결하고 호스트 규칙 9항목·Forward+ 현재 원정 19항목, 1280/960 화면·SFX 출력·저장을 확인했다. 외부망/6인과 모든 스킬 개별 검수는 별도다.

2026-09-14 [지표 비행 생물 교전·T2 제트팩](production/178-flying-wildlife-and-jetpack.md): 지상 대기 비행종 140종의 3D 추격·공격·도주·무력화와 등 장착/재입력 상승·잔량·공중 사격을 연결했다. Blender 원본과 Forward+ 착용·실제 원정의 제작/상승/교전/저장을 확인했다. 아래 177 당시의 비행 AI 미구현 상태보다 이 기록이 우선하며 수중 교전은 이번 범위가 아니다.

2026-09-14 [전체 동물의 체형별 빠른 이동](production/177-creature-fast-motion-rollout.md): 5,600종에 빠른 동작 5,671개를 추가하고 게임 최고속을 유지하는 재생 배속·가속/감속·선회·위치 보간을 연결했다. 같은 날 후속 정정으로 애니메이션 기준의 이동속도 제한을 제거했다. 골격 11,200개 전수 대조, 대표 17종 Blender/Forward+와 실제 T4 교전·저장을 확인했다. 전종 개별 미적 검수·외부망/6인·수중/비행 전투 AI와 배포 검증은 소관 기록에서 구분한다.

2026-09-13 [생물 고속 이동·도주·돌진 표본 조사](production/176-creature-speed-and-gait-audit.md): 현재 5종의 걷기 배속/달리기 전환을 Forward+에서 비교했다. 보폭·전투 속도 불일치와 위치 추종 출렁임을 확인했으며, 속도/모델 변경은 아직 적용하지 않았다.

2026-09-13 [선체 상호 충돌·물리 피해·미사일 음향](production/175-flight-collision-and-audio.md): 고속 통과를 막고 질량별 반응·양쪽 피해, 전투 밖 긴급 복구와 새 ElevenLabs 3종을 연결했다.

2026-09-13 [기체 이동속도·이족 리깅·발 접지](production/174-coopertech-locomotion.md): 이족 2종의 골반/관절과 접지 기본 자세를 수정하고 가까운 분대의 20Hz 이동 및 속도·방향별 보행을 연결했다. 후속에서 실제 최고속·회전 중 다리 순서 문제도 확인해 보정했다.

2026-09-13 [지구를 등지는 근접 출발·첫 가이드 복구](production/173-earth-departure-and-guide.md): 짧은 실제 전진, 원정별 가이드 01 시작, 스캔 결과 표시 우선순위와 빈 관측 창을 수정했다. 전체 출항·업무 안내·가이드와 작은 화면을 확인했으며 기존 경로/진행은 보존한다.

2026-09-13 **구형 동물 자산 정리** — [172](production/172-retired-animal-assets.md): 구형 5,600종 바이너리·임포트 작업 사본·중복 기록을 정리하고 도감/표본도 새 모델을 사용한다. 저장 카탈로그·식물/미생물·현재 자산과 Git 이력은 보존한다.

2026-09-13 [지표 재질 43종·국소 무늬 변화](production/170-surface-material-expansion.md): 사막·암석·빙결 재질 18종과 시드별 보조 지면·무늬 방향/좌표 변형·풍화색을 연결한다. Blender·실제 지상 비교와 기존 저장/성능 경계는 제작 기록을 따른다.

2026-09-13 [선체별 실내와 게스트 비행 관전](production/171-vessel-interiors-and-observer.md): 공동선 9종의 내부·넓은 관측창과 조종 없는 F8 호스트 시점을 연결한다. 기존 저장·변경 범위와 실제 확인은 소관 기록에서 구분한다.

2026-09-13 [사격 반응·양팔 IK·지속 레이저·지연 보정](production/169-firearm-precision-and-laser.md): 9계열·17개 장비와 레이저 전지, 실제 골격 피격 경계, 최대 200ms 호스트 이력, 현재 원정/6개 ENet 연결 검수와 남은 품질 경계를 구분한다.

2026-09-13 [T3·T5 선체 6종과 스킬](production/168-advanced-hulls-and-skills.md): 세 역할 계열·14종 능력의 고유/별도 장착·공유 강화, 실제 적재량·항해 능력·패시브를 연결했다. Blender/Forward+·정거장·비행 효과/재생·저장과 미확인 운용 범위를 구분한다.

2026-09-13 [쿠퍼테크 기체 2종·분대 조우](production/167-coopertech-squads.md): BASTION 포격형·RAPTOR 4족 추적형, T1부터의 복수 휴면/활성 순찰과 티어별 강화. 기존 단독 로봇 저장과 실제 검수 경계를 구분한다.

2026-09-13 [총기·탄약·재장전·탄도](production/166-firearm-ammunition-and-ballistics.md): 약한 무한 예비탄 권총, 탄약 5종 제작·운반·부분 장전, 양손 리그와 계열별 반동/조준, 실제 탄속/낙차와 저장 중 클릭 보관을 적용했다. 8계열 실제 원정 렌더·탄약 저장/보관·지연 이벤트 확인과 미확인 품질을 구분한다.

2026-09-13 [전진 비행·Q/E 롤·적 선회](production/165-forward-flight.md): 속도 유지·정지/정밀 후진, F 궤도 상호작용과 기수 방향으로 전진하는 해적 기동을 적용했다. 실제 Forward+·호스트 입력·저장 확인과 Mac 잠금으로 인한 직접 조작 미확인 범위를 구분한다.

2026-09-12 **동물 56종 묶음 리모델링** — [159](production/159-creature-remodel-batch.md): 실제 구조가 다른 56종·40가지 관절 연결·11개 동작과 두 LOD를 제작하고 4.025m/s 도주·경사 접지를 렌더했다. 누적 제작 65종, 일반 원정 표시 62종이며 전체 5,600종 완료와 구분한다.

2026-09-12 [일반 거래 비동기 확정·지역별 초안](production/160-transaction-drafts.md): 일반 요청의 동기 파일 저장을 순서 보장 작업 스레드로 옮기고, 개인 장비·날씨·사건의 변경 범위만 독립 복사한다. 저장 전 전체 검증·직렬화용 복사와 산업의 전체 초안 비용은 남는다.

2026-09-12 **단일 행동의 전체 처리 필수 검사** — [158 조사](production/158-action-scope-audit.md): 닫힌 아이템창·카드 재생성·실패 요청 발행·배치 광맥 재생성을 줄였다. 일반 거래의 전체 동기 저장과 정기 후보 복사 등 남은 구조적 비용을 구분한다.

2026-09-12 **동물 리모델링 첫 원정 연결** — [157](production/157-creature-remodel-field.md): 8종의 실제 임포트·빠른 이동·경사 접지·LOD를 렌더하고, 호스트 행동과 호환되는 6종의 일반 표시를 교체했다. 돌진/도약·비행·저장된 생물 사건과 전체 제작은 별도다.

2026-09-12 [시작·채광·현장 사용성 정정](production/156-start-and-field-polish.md): 지구 근접 출발, 채광 조회/저장 지연 개선, 지형 지도, 소형선 호출·건설 회전·공동 설비 연구와 UI 정리를 반영한다. 요청 처리 시간과 전체 FPS·실제 확인 범위를 구분한다.

2026-09-12 **전체 동물 리모델링 착수** — [155](production/155-creature-remodel-rollout.md): 승인 기준을 커밋하고 5,600종 목록과 첫 추가 고리형·오방사형·긴 목형을 제작한다. 현재 제작/렌더와 원정 적용 단계를 구분한다.


2026-09-12 **대표 생물 빠른 이동·타격 효과 정정** — [154 후속](production/154-creature-motion-and-contact.md): 기존 외형·9동작을 보존하고 전용 빠른 이동을 더해 10클립으로 확장했다. 거리와 보폭/발 교대 연결, 걷기→가속→빠른 이동→감속→정지와 노란 타격 링 제거를 렌더하고 18개 타격 결과를 확인했다. 기존 원정·8,000종 적용은 별도다.

2026-09-12 **생물 외형 승인·동작/타격 고도화** — [154 제작 기록](production/154-creature-motion-and-contact.md): 승인한 여섯 대표의 메시를 보존하고 체형별 9클립과 실제 접촉·실드·회피 반응을 검토 장면에 연결했다. 여섯은 검토 대표 수이며 전체 리깅의 종류 제한이 아니다. 생물군별 전용 리깅 원칙과 원정 미적용 범위를 구분한다.

2026-09-12 **유형별 대표 시안** — [외계 동물 조형·이동·공격](production/153-creature-type-studies.md): 특이한 조형을 유지하고 6개 대표에 새 Blender 모델·골격·네 동작을 제작해 INK로 재렌더했다. 근접 3유형·원거리 3유형의 동작/투사체 시각화이며 기존 8,000종·현장 전투는 교체하지 않았다.

2026-09-12 **조사·문서화** — [생물 외형·움직임 품질 조사](production/152-creature-quality-audit.md): 8,000종과 실제 자산 구조를 집계하고 대표 6종을 현재 INK 구동기로 렌더했다. 동물의 조립식 체형·단일 다리 관절·몸통/생활 동작 한계와 개선 우선순위를 정리했으며 모델·게임 기능은 변경하지 않았다.

2026-09-12 [45초 가로 홍보 하이라이트](production/151-instagram-impact-trailer.md): T3 무기·우주전·완성 기지와 같은 장소의 환경 변화를 빠르게 편집하고 ElevenLabs 전용 음악을 제작했다. 촬영 연출과 게임 구현·성능 확인의 범위를 구분한다.

2026-09-12 [생물 발견 번호·도감 명명](production/150-discovery-names.md): 종류별 발견 순번, 도감 이름 편집, 스캔/표본 표시와 공동 저장을 연결한다. 기존 제작 이름·종 원산지는 보존한다.

2026-09-12 [지상 프레임 지연 개선](production/147-ground-frame-budget.md): 생물 접지 예산·자동 저장 병합/작업 스레드·지표/사업 화면 재사용·지도 생성 분리를 적용했다. 지도 정지와 반복 CPU 비용은 줄었으며 저장 제출·순간 지연·고해상도 GPU 여유는 남는다.

2026-09-12 [항해 전투 성능 조사](production/146-pirate-performance.md): 불변 행성 정의·같은 시각의 충돌 목록과 효과 자원을 재사용하고 주기 저장을 작업 스레드에 연결했다. M2 보통 옵션의 실제 프레임과 1080p·동시 격파의 남은 지연을 기록했다. 안정적인 60 FPS 달성은 아니다.

2026-09-12 [지상 무기 공격·타격감](production/145-ground-weapon-feedback.md): 8계열의 절제된 발사·착탄에 후속으로 적별 합산 피해 숫자, 실드 파괴 표식·파편·음원과 자기 실드 피격/파괴를 연결했다. 실제 화면·출력·저장 확인과 청감/협동 미확인 범위는 기록을 따른다.

2026-09-12 [전투함 편대·유도 미사일·성간 탈출](production/144-pirate-missiles-and-breakout.md): 좌클릭 펄스와 우클릭 곡선 유도 미사일, 실제 명중 폭발, 추격 전투함/미사일함 편대와 거리 확보 후 성간 출발을 연결했다. 왼쪽 상태는 지상과 같은 실드/체력/스태미나 아이콘, 오른쪽은 두 무장으로 정리했다. 제작·검수·기존 저장 경계는 기록을 따른다.
...
2026-09-10 [T3~T5 선박 항해 조건](production/116-vessel-tier-access.md): T1·T2 기초선 접근, 현재 선체의 세 항해 내성, T3 성능 선체 구매/선체별 개장, 지도 경고와 FINCH 우회 방지를 연결했다. 기존 저장의 외곽 귀환을 유지한다. 변경 전 24분대 측정과 현재 밸런스를 구분하며 실제 검사·화면 범위는 제작 기록에 둔다.

2026-09-10 **선박 진입 조건 적용 전** [1인·2인 T3 진입 시간](production/109-t3-progression-benchmark.md): 같은 시드의 자동 조작 경로에서 첫 Mk.3 제작소와 T3 착륙까지 연속 완료했다. T3 착륙은 1인 24분 27초·2인 23분 21초이며, 크레딧·채집·물류 기록과 헤드리스/작업 분담 조건을 함께 남겼다. 사람의 평균 플레이·전체 설계도 확보·행성 판매 시간과 구분한다.

2026-09-10 [모든 행성의 근접 표면·품질 옵션](production/113-orbital-surface-quality.md): 생성 18종과 태양계/복원 화성의 표면 맵·거리별 세부 무늬·개인 그래픽 3단계를 연결했다. 실제 확인과 성능 경계는 제작 기록을 따른다.

2026-09-10 [복원 결과의 우주 외형](production/112-orbital-terraforming.md): 저장된 지역 복원과 구면 대기를 실제 비행·항성지도·재방문에 연결했다. 기존 완료 기록도 반영하며 공간 요약과 실제 확인 경계는 제작 기록을 따른다.
...
2026-09-10 [T3 설비 준비·대표 수급 경로](production/107-tier3-preparation-and-economy.md): 설치 전 원료·가공·직접 운반 견적과 기초 광맥 누락 안내를 연결했다. 출항 지급품/실제 채집으로 두 거점과 첫 Mk.3 제작소를 마련한 경로를 확인했으며, 전체 계약 완주·운송 시간과 구분한다.
...
2026-09-10 [T3 설계도 획득·묶음 생산·보급 계획](production/105-tier3-blueprints-and-supply.md): 정거장 6종 확정 판매와 낡은 기록고 복원, 현장 제작 예약·5분 소모품 계획을 연결했다. 실제 실행 결과와 준비 데이터·남은 범위는 제작 기록을 따른다.
...
- [조준 대상과 스캔 결과 분리](production/148-target-identity-and-scan-results.md) — 생물 평시 이름/표본 제거, 4초 스캔 결과와 미조사 대상 표시·실제 확인.

- [지상 타격 형태 교체](production/149-ground-impact-shapes.md) — 비대칭 접촉 섬광·미세 파편·끊어진 실드 호와 실제 확인.
