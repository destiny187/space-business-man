...
2026-09-12 토착 지상 생물 교전용 경고·타격·피격 3종을 생성·연결했다. 생성 조건·편집·실제 재생과 청감 미확인 범위는 [137 제작 기록](137-native-wildlife-combat.md)을 따른다.

2026-09-12 지상전 음원: 발사 8계열·재장전·명중·실드 파괴 11종을 ElevenLabs 생성 원본으로 연결하고 재장전 시간·메뉴 정지를 반영했다. [적용·실제 재생과 청감 미확인 범위](136-ground-combat-foundation.md)를 따른다.
...
2026-09-14 기존 플레이의 표시/믹스/복귀 고도화 실제 범위는 [Q07~Q09 제작 기록](../production/183-polish-combat-audio-and-coop.md)을 따른다. 초기 구현과 전수 체감·외부망 검수를 구분한다.
