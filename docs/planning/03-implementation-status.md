...
**2026-09-06 탐험 확장은 E0 기능 실증을 진행 중이다.** 100만 주소의 시드 은하·3D 항해와 착륙·국소 굴착·지하 저장/도보 왕복을 부분 구현했다. 우주선 추첨/개발·자동화와의 연결·발견 연구/표본 이식·다단계 문명 외교·호스트 포함 최대 6인 협동은 아직 통합하지 않았다. 아래 1.2 실행·테스트 결과와 새 실증을 구분한다. [확장 개발 기록](07-expansion-development-log.md) · [미완료 인수 표](06-exploration-expansion-roadmap.md).
